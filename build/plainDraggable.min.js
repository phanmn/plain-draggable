...
},{}],"cjFF":[function(require,module,exports) {
...
},{}],"O69e":[function(require,module,exports) {
"use strict";function t(t){return(t+"").trim()}function n(t,n){n.setAttribute("class",t.join(" "))}function e(e,i,r){r.filter(function(n){return!(!(n=t(n))||-1!==e.indexOf(n))&&(e.push(n),!0)}).length&&n(e,i)}function i(e,i,r){r.filter(function(n){var i=void 0;return!(!(n=t(n))||-1===(i=e.indexOf(n)))&&(e.splice(i,1),!0)}).length&&n(e,i)}function r(e,i,r,o){var u=e.indexOf(r=t(r));return-1!==u?!!o||(e.splice(u,1),n(e,i),!1):!1!==o&&(e.push(r),n(e,i),!0)}function o(e,i,r,o){var u=void 0;(r=t(r))&&(o=t(o))&&r!==o&&-1!==(u=e.indexOf(r))&&(e.splice(u,1),-1===e.indexOf(o)&&e.push(o),n(e,i))}function u(n){return!u.ignoreNative&&n.classList||(c=(n.getAttribute("class")||"").trim().split(/\s+/).filter(function(t){return!!t}),f={length:c.length,item:function(t){return c[t]},contains:function(n){return-1!==c.indexOf(t(n))},add:function(){return e(c,n,Array.prototype.slice.call(arguments)),u.methodChain?f:void 0},remove:function(){return i(c,n,Array.prototype.slice.call(arguments)),u.methodChain?f:void 0},toggle:function(t,e){return r(c,n,t,e)},replace:function(t,e){return o(c,n,t,e),u.methodChain?f:void 0}});var c,f}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0,u.methodChain=!0;var c=u;exports.default=c;
